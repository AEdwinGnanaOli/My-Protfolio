  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Edwin Gnana Oli</h1>
          </Link>
        </div>
        <div>
          <ul className="lg:flex items-center hidden">
            ...
            <a
              ...
              href="https://drive.google.com/file/d/1XVGUDk46Uz_pVXOjkQxxwM-kxu_pLaAA/view?usp=sharing"
              target="blank"
            >
              <PrimaryBtn>
                <span>Resume</span>
